            ...
            '/translation/luajit/': [
                {
                    ...
                    collapsed: false,
                    items: [
                        {text: 'ホーム', link: '/translation/luajit/'},
                        {text: 'LuaJIT', link: '/translation/luajit/luajit'},
                        {text: 'ダウンロード', link: '/translation/luajit/download'},
                        {text: 'インストール', link: '/translation/luajit/installation'},
                        {text: '実行する', link: '/translation/luajit/running'},
                        {text: '拡張機能', link: '/translation/luajit/extensions'},
                        {text: 'FFIライブラリ', link: '/translation/luajit/ffi_library'},
                        {text: 'FFIチュートリアル', link: '/translation/luajit/ffi_tutorial'},
                        {text: 'ffi.* API', link: '/translation/luajit/ffi_api'},
                        {text: 'FFIセマンティクス', link: '/translation/luajit/ffi_semantics'},
                        {text: 'String Buffers', link: '/translation/luajit/string_buffers'},
                        {text: 'jit.* Library', link: '/translation/luajit/jit_library'},
                        {text: 'Lua/C API', link: '/translation/luajit/lua_c_api'},
                        {text: 'プロファイラ', link: '/translation/luajit/profiler'},
                        {text: 'ステータス', link: '/translation/luajit/status'},
                        {text: 'FAQ', link: '/translation/luajit/faq'},
                        {text: 'メーリングリスト', link: '/translation/luajit/mailing_list'},
                        {text: 'スポンサー', link: '/translation/luajit/sponsors'},
                    ]
                },
            ],
            ...
            '/translation/skia/': [
                {
                    ...
                    items: [
                        ...
                        {text: 'Skiaのダウンロード方法', link: '/translation/skia/how_to_download_skia.md'},
