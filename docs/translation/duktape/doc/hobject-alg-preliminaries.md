...
A maximum prototype chain depth should be imposed as a safeguard against
...
Because user code has not had any access to the object, we can narrow
...
-   Since `[[Get]]` is used to read the descriptor value fields, they
