...
Similar mantissa chopping limits can be established for non-decimal
...
It\'s important to optimize for typical cases, but simultaneously
...
Having 10\^k tabulated for 326 values would take too much memory: each
