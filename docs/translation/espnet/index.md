...
ESPnetは、エンドツーエンドの音声認識、テキスト音声、音声翻訳、音声拡張、話者日記、音声言語理解などをカバーする、エンドツーエンドの音声処理ツールキットです。
ESPnetでは、深層学習エンジンとして[pytorch](http://pytorch.org/)を採用し、さらに[Kaldi](http://kaldi-asr.org/)スタイルのデータ処理、特徴抽出/フォーマット、レシピに準拠し、様々な音声処理実験に対応した完全なセットアップを提供します。

## チュートリアルシリーズ
- 2019 Interpeechでのチュートリアル
...
- Architecture
    ...
    - VITS
    - JETS
- Multi-speaker & multi-language 拡張
    - Pretrained speaker embedding (例：X-vector)
    - Speaker ID embedding
    - Language ID embedding
    - Global style token (GST) embedding
    - Mix of the above embeddings
- End-to-end 学習
    - End-to-end text-to-wav モデル (例：VITS、JETSなど)
...
デモの様子
- ESPnet2によるリアルタイムTTSデモ [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/espnet/notebook/blob/master/espnet2_tts_realtime_demo.ipynb)
...
ニューラル・ボコーダの学習には、以下のリポジトリをご利用ください。
- [kan-bayashi/ParallelWaveGAN](https://github.com/kan-bayashi/ParallelWaveGAN)
- [r9y9/wavenet_vocoder](https://github.com/r9y9/wavenet_vocoder)

> **NOTE**:
> - TTSのために、ESPnet2ベースの開発を進めています。
> - ESPnet1-TTSの使用は非推奨です。[ESPnet2-TTS](https://github.com/espnet/espnet/tree/master/egs2/TEMPLATE/tts1)を使用してください。
